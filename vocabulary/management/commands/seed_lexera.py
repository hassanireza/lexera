...
WORDS = [
    ...
    ("ambitious", "adjective", 3, "Having a strong desire for success or achievement.", "She is ambitious about her career.", "/æmˈbɪʃəs/", "Latin 'ambitiosus', from 'ambire' (to go around)", "14th century", "Originally described politicians literally walking around to gather votes.", []),
    ...
    ("serendipity", "noun", 4, "The occurrence of events by chance in a happy way.", "Meeting her was pure serendipity.", "/ˌsɛrənˈdɪpɪti/", "Coined by Horace Walpole (1754), Persian fairy tale", "1754", "Invented for a fairy tale about princes making lucky discoveries.", []),
